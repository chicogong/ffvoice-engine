...
TEST_F(AudioConverterTest, Resample_SameRate) {
    ...
    AudioConverter::Resample(input.data(), input.size(), 48000, output.data(), output.size(),
                             48000);
...
TEST_F(AudioConverterTest, Resample_Downsample3x) {
    ...
    AudioConverter::Resample(input.data(), input.size(), 48000, output.data(), output_size, 16000);
...
TEST_F(AudioConverterTest, Resample_Upsample2x) {
    ...
    AudioConverter::Resample(input.data(), input.size(), 24000, output.data(), output_size, 48000);
...
TEST_F(AudioConverterTest, Resample_PreservesEnergy) {
    ...
    AudioConverter::Resample(input.data(), input_size, 48000, output.data(), output_size, 16000);
