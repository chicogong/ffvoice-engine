...
| `transcribe_file_with_diarization` | 转写并标注说话人 —— 每段带 `speaker_id`，回答"谁在何时说什么"（需 `ENABLE_DIARIZATION` 构建） |
...
- ✅ **集成层路线图 (v0.7.0)**: Agent 集成 (CLI + MCP) / 实时字幕流 / 说话人分离 - 完成
