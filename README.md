...
四个集成层路线图阶段全部交付，已发布到 PyPI（macOS / Linux / Windows，Python 3.10–3.13）。
...
- CI 矩阵覆盖 Linux / macOS / Windows × Python 3.10–3.13
...
- ✅ **集成层路线图 (v0.8.1)**: Agent 集成 (CLI + MCP) / 实时字幕流 / 说话人分离 - 完成
